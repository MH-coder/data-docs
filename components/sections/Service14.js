...
const advantages = [
    {
        title: "Completely Tax Free",
        description: "In 95% of cases our clients are exempt from income, capital gains, company profits and sales taxes.",
        background: ""
    },
    {
        title: "100% Anonymous",
        description: "In Dubai and the United Arab Emirates there are no publicly available company registers and documents.",
        background: ""
    },
    {
        title: "Almost non-existent bureaucracy",
        description: "The bureaucratic commitment for a company in Dubai is extremely reduced compared to European countries.",
        background: ""
    },
    {
        title: "No residency requirement",
        description: "As a company owner, to keep your visa active you simply need to enter the country every 6 months for at least 24 hours.",
        background: ""
    }
]

export default function Service14() {
    ...
    return (
        <>
            <section className="service-section bg_op_1 position-relative" style={{ background: 'url(/assets/images/home-13-service-bg.jpg)' }}>
                {/*===============shape==============*/}
                ...
                <div className="auto-container">
                    <div className="row">
                        <div className="col-lg-9 m-auto">
                            <div className="title_all_box style_six text-center light_color">
                                <div className="title_sections">
                                    <div className="before_title">
                                        <span className="icon-briefcase icon" />
                                        YOUR BENEFITS
                                    </div>
                                    <div className="title">Advantages of a company in Dubai</div>
                                    ...
                                    <div className="tab_over_all_box">
                                            ...
                                            <ul className="showcase_tabs_btns nav-pills nav clearfix">
                                                {
                                                    advantages.map((advantage, index) => {
                                                        return <li className="nav-item">
                                                            <a className={activeIndex1 === index + 1 ? "s_tab_btn nav-link active" : "s_tab_btn nav-link"} onClick={() => handleOnClick1(index + 1)} data-tab="#tabtabone">0{index + 1}. {advantage.title}</a>
                                                        </li>
                                                    })
                                                }
                                            </ul>
                                        ...
                                        <div className="s_tab_wrapper">
                                            <div className="s_tabs_content">
                                                {
                                                    advantages.map((advantage, index) => {
                                                        return <div className={activeIndex1 === index + 1 ? "s_tab fade active-tab show" : "s_tab fade"} id={`tabtab${index + 1}`}>
